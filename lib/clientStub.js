...
var DgraphClientStub = (function () {
    ...
    DgraphClientStub.prototype.DEPRECATED_detectApiVersion = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4, this.query({ query: "schema {}", startTs: 0 })];
                    case 2:
                        _a.sent();
                        return [2, this.legacyApi];
                    case 3:
                        e_1 = _a.sent();
                        if (!e_1.errors || e_1.errors.length === 0 || e_1.errors[0].code !== "ErrorInvalidRequest") {
                            throw e_1;
                        }
                        return [3, 4];
                    case 4:
