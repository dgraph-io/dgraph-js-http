...
var DgraphClientStub = (function () {
    ...
    DgraphClientStub.prototype.alter = function (op) {
        ...
        var config = __assign({ method: "POST", body: body }, this.options);
    ...
    DgraphClientStub.prototype.query = function (req) {
        ...
        var config = __assign({ method: "POST", body: req.query, headers: headers }, this.options);
    ...
    DgraphClientStub.prototype.mutate = function (mu) {
        ...
        var config = __assign({ method: "POST", body: body,
    ...
    DgraphClientStub.prototype.commit = function (ctx) {
        ...
        var url = !this.legacyApi
            ...
            : "commit/" + ctx.start_ts;
        var options = __assign({ method: "POST", body: body }, this.options);
    ...
    DgraphClientStub.prototype.abort = function (ctx) {
        var url = !this.legacyApi
            ...
            : "/abort/" + ctx.start_ts;
        var options = __assign({ method: "POST" }, this.options);
        return this.callAPI(url, options);
    };
    ...
    DgraphClientStub.prototype.fetchUiKeywords = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.callAPI("ui/keywords", __assign({}, this.options))];
            });
        });
    };
    DgraphClientStub.prototype.getHealth = function (all) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.callAPI("health" + (all ? "?all" : ""), __assign({}, this.options))];
            });
        });
    };
    DgraphClientStub.prototype.getState = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.callAPI("state", __assign({}, this.options))];
            });
        });
    };
